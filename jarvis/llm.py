...
def gen_llm(cmd, gui):
    ...
    try:
        ...
        sys_prompt = (
            ...
            "- Close app: Stop-Process -Name <processname> -Force\n"
            "  Common process names: calc=CalculatorApp.exe, notepad=notepad.exe, chrome=chrome.exe, edge=msedge.exe, vscode=Code.exe, spotify=Spotify.exe, discord=Discord.exe\n"
