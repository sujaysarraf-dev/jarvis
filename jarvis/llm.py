...
def gen_llm(cmd, gui):
    ...
    try:
        ...
        sys_prompt = (
            ...
            "- Close app: Stop-Process -Name <name> -Force   (name WITHOUT .exe, e.g. CalculatorApp not CalculatorApp.exe)\n"
            "  Common process names: CalculatorApp, notepad, chrome, msedge, Code, Spotify, Discord\n"
