...
def gen_llm(cmd, gui):
    ...
    try:
        ...
        sys_prompt = (
            ...
            "- Open app: Start-Process <exe_or_filepath>   (e.g. calc, notepad, chrome, explorer, msedge, code, spotify, not 'Calculator')\n"
            "- Close app: Stop-Process -Name <name> -Force   (NO .exe, e.g. CalculatorApp)\n"
            "Open/Close pairs: open calc / close CalculatorApp | open notepad / close notepad | open chrome / close chrome | open edge / close msedge | open code / close Code | open spotify / close Spotify\n"
